...
export const SS_NAV: NavItem[] = [
  { id: "about", label: "회사소개", href: "/about" },
  {
    ...
    children: [
      ...
      { num: "02", title: "DBSAFER", titleEn: "DBSAFER", mark: "S", cat: "ACCESS CONTROL", desc: "DB · 시스템 · OS 접근제어", href: "/ssq-co/dbsafer" },
  ...
  },
  {
    ...
    children: [
      ...
      { num: "02", title: "Arcus AI SBOM", titleEn: "Arcus AI SBOM", mark: "B", cat: "SUPPLY CHAIN", desc: "소프트웨어 BOM 분석 · 공급망 보안 · CVE 매핑", href: "/ssq-io/sbom" },
